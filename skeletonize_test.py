...
def test_func(image):
    ...
    draw_line_from_points(image, filtered_points, (0, 0, 255), 5)
    # Display the centerline points
    for point in filtered_points:
        cv2.circle(image, point, 4, (255, 0, 0), -1)  # Draw a green circle at each point
    return image
...
# Display the result
cv2.imshow('Centerline Points', image)
cv2.waitKey(0)
